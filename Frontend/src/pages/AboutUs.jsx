...
import weDo from '../img/we-do/graph-img.svg';
...
const AboutUs = () => {
    ...
    return (
        <>
            {/*========================= we-do-section start========================= */}
            <section id="about" className="we-do-section pt-150 pb-100">
                <div className="shape shape-1">
                    <img src={svg1} alt="svg photo" />
                </div>
                    ...
                    <div className="row">
                        <div className="col-xl-12">
                            <div className="graph mb-60">
                                <img src={weDo} alt="what we do middle photo" />
                            </div>
                        </div>
