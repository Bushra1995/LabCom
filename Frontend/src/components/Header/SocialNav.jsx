...
export default function SocialNav() {
    ...
    return (
        <div className="" style={{ backgroundColor: "#3AA6B9" }}>
            <nav className="lg:container lg:mx-auto sm:py-2 sm:px-4 py-2 px-2">
                ...
                <div className="flex justify-between ">
                    ...
                    <Link to="/" className="text-white">
                        <svg className="text-black h-6 w-6 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 21V13.5L12 10.5L15 13.5V21M9 21H15M5 14.1V21H2V12H0L12 3L24 12H22V21H19V14.1"></path>
                        </svg>
                    </Link>
